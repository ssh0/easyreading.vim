...
let s:p.insert.left = [ [ s:darkgreen, s:base3, 'bold' ], [ s:base3, s:green ] ]
let s:p.insert.middle = [ [ s:lightgreen, s:darkgreen ] ]
let s:p.insert.right = [ [ s:darkgreen, s:lightgreen ], [ s:lightgreen, s:green ] ]
